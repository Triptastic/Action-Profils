...
Action[ACTION_CONST_PALADIN_RETRIBUTION] = {
    ...
    HolyAvenger                            = Create({ Type = "Spell", ID =  }),
    Crusade                                = Create({ Type = "Spell", ID = 231895 }),
    FinalReckoning                         = Create({ Type = "Spell", ID =  }),
    Seraphim                               = Create({ Type = "Spell", ID =  }),
    SeraphimBuff                           = Create({ Type = "Spell", ID =  }),
    ...
    VanquishersHammer                      = Create({ Type = "Spell", ID =  }),
    FinalReckoningDebuff                   = Create({ Type = "Spell", ID =  }),
