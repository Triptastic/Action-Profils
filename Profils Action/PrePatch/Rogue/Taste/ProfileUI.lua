        ...
        LayoutOptions = { gutter = 4, padding = { left = 5, right = 5 } },		
            ...
            { -- [3] 3rd Row 
                ...
                },
                {
                    ...
                    DBV = false,
                    L = { 
                        enUS = "Use " .. GetSpellInfo(298277) .. " in AoE", 
                        ruRU = "использование " .. GetSpellInfo(298277) .. " в AoE", 
                        frFR = "Utiliser " .. GetSpellInfo(298277) .. " en AoE", 
                    }, 
                    TT = { 
                        enUS = "Use " .. GetSpellInfo(298277) .. " to get maximum burst in AoE situations." , 
                        ruRU = "использование " .. GetSpellInfo(298277) .. " чтобы получить максимальный взрыв в AoE ситуациях." ,
                        frFR = "Utiliser " .. GetSpellInfo(298277) .. " pour obtenir un burst maximal dans les situations AoE." ,
                    }, 
                    M = {},
                }, 
            },
