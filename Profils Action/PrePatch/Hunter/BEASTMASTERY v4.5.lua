...
A[3] = function(icon, isMulti)
    ...
    local function EnemyRotation(unit)
	    ...
	    then 	
            ...
            if inCombat and A.AspectoftheWild:IsReady(player) and ((AspectoftheWildTTD > 0 and Unit(unit):TimeToDie() >= AspectoftheWildTTD) or Unit(unit):TimeToDie() >= 0) and Unit(player):HasBuffs(A.AspectoftheWildBuff.ID, true) == 0 and HandleAspectoftheWild() and 
			(
