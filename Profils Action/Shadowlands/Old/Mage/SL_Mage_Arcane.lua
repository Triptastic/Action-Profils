...
Action[ACTION_CONST_MAGE_ARCANE] = {
    ...
    KnotofAncientFury                      = Action.Create({ Type = "Trinket", ID = 166795 }),
...
A[3] = function(icon, isMulti)
    ...
    local function EnemyRotation(unit)
		...
		if Unit("player"):GetLevel() < 60 then
        ...
        if A.TouchoftheMagi:IsReady(unit) and (A.ArcanePower:GetCooldown() == 0 and Player:ArcaneChargesP() == 0 and S.Evocation:GetCooldown() <= VarAverageBurnLength) then
