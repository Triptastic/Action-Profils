...
Action[ACTION_CONST_DEMONHUNTER_HAVOC] = {
	...
	-- Havoc DemonHunter Legendaries 
	ChaosTheory                            = Action.Create({ Type = "Spell", ID = 337551  }),
    DarkestHour                            = Action.Create({ Type = "Spell", ID = 337539  }),
    ErraticFelCore                         = Action.Create({ Type = "Spell", ID = 337685  }),
    InnerDemons                            = Action.Create({ Type = "Spell", ID = 337548  }),
	-- Oils
