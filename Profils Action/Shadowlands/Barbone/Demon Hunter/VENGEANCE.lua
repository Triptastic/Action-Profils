...
Action[ACTION_CONST_DEMONHUNTER_VENGEANCE] = {
    ...
    EnduringGloom                          = Action.Create({ Type = "Spell", ID = 319978     }),
	-- General DemonHunter Legendaries
	CollectiveAnguish                      = Action.Create({ Type = "Spell", ID = 337504  }),
    DarkglareBoon                          = Action.Create({ Type = "Spell", ID = 337534  }),
    FelBombardment                         = Action.Create({ Type = "Spell", ID = 337775  }),
    HalfGiantEmpowerment                   = Action.Create({ Type = "Spell", ID = 337532  }),
	-- Vengeance DemonHunter Legendaries 
	FelFlameFortification                  = Action.Create({ Type = "Spell", ID = 337545  }),
    FierySoul                              = Action.Create({ Type = "Spell", ID = 337547  }),
    RazelikhsDefilement                    = Action.Create({ Type = "Spell", ID = 337544  }),
    SpiritoftheDarknessFlame               = Action.Create({ Type = "Spell", ID = 337541  }),
	-- Oils
